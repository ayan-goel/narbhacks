...
const benefits = [
  {
    title: "Beautiful Wrapped Cards",
    description: "Generate stunning visual summaries of your ChatGPT journey",
    image: "/images/goodNews.png",
  },
  {
    title: "Instant Analytics",
    description:
      "Discover your conversation patterns, topics, and AI interaction insights.",
    image: "/images/cloudSync.png",
  },
  {
    title: "Easy Sharing",
    description:
      "Share your wrapped cards on social media or export as images and PDFs.",
    image: "/images/googleCalander.png",
  },
  {
    title: "AI-Powered Insights",
    description:
      "Get personalized insights about your AI usage patterns and personality.",
