    ...
    <>
      ...
      <div className="container sm:hidden pt-7 pl-6 pr-5">
        ...
        <p className="text-[#667085] font-inter text-center text-base not-italic font-light leading-[18px] py-11">
          © 2024 ChatGPT Wrapped. All rights reserved. <br />
